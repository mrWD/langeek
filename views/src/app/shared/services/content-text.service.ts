...
const mapLangToContent = (lang: string): any => ({
  english: {
    ...
    profession: {
      ...
      text2: 'Let\'s look at a few more important verbs:',
  ...
  german: {
    ...
    profession: {
      ...
      text2: 'Schauen wir uns ein paar weitere wichtige Verben an:',
  ...
  russian: {
    ...
    profession: {
      ...
      text2: 'Рассмотрим еще несколько важных глаголов:',
  ...
  polish: {
    ...
    profession: {
      ...
      text2: 'Przyjrzyjmy się kilku ważniejszym czasownikom:',
  ...
  italian: {
    ...
    profession: {
      ...
      text2: 'Diamo un\'occhiata ad alcuni verbi più importanti:',
  ...
  french: {
    ...
    profession: {
      ...
      text2: 'Regardons quelques verbes plus importants:',
